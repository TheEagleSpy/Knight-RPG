...
def updatelog():
    ...
    print("-Added some small enemy scaling to the Forest enemies")
    ...
    print("\n-----Previous Version: V5-----")
    print("-FINISHED ALL THE MAIN CONTENT OF THE GAME!!!!")
    ...
    print("-You can only encounter a max of two traps or two enemies in a single day")
    print("-Medium enemies can only be seen after day 5 in the forest and day 18 in the frozen peaks")
    print("-Hard enemies can only be seen after day 8 in the forest and day 23 in the frozen peaks")
    print("-Added a quick help menu when first opening the game")
    print("\n---Bugs/Changes---")
    print("-Changed traps to now deal 1 less damage per defence")
    print("-Changed blacksmith navigation to be clearer")
    print("-Changed the blacksmith to be able to upgrade cloth armour for +1 defence")
    print("-Changed the lost villager to have a 70% chance to not attack you if you steal")
    print("-Changed the guard so that he leaves the hall door once the baron is dead")
    print("-Changed the wording in the rules for twenty one")
    print("-Changed the shiny sword event, companion option to only need 1 companion and not 2 to pull the sword out")
    print("-Changed the shiny sword event max health option from 200 max health to 150 max health to pull the sword out")
    print("-Changed the wording of the aurora event to make more sense")
    print("-Changed a line in the forest blacksmith so that it would say -100 instead of - 100")
    print("-Changed some of the wording for the klare villagers")
    print("-Buffed health gained from riding with the people on the caravan from +90 to +150")
    print("-Nerfed Baron's damage from (145 dmg) -> (125 dmg)")
    print("-Nerfed Dragon's damage from (190 dmg) -> (175 dmg)")
    print("-Fixed Liars Dice skip to end not working")
    print("-Fixed being able to go over your max health during exploration")
    print("-Fixed not being forced to fight BIGFOOT and the DRAGON on day 30 and day 45")
    print("-Fixed your health being able to go over your max health while in battle from lifesteal")
    print("-Fixed enemy scaling working on zone bosses")
    print("-Fixed Forest merchant not saying how much health the potion will give")
    print("-Fixed Frozen Peaks merchant saying health potion gives +50 health when it actually gives +75 health")
    print("-Fixed a logic error when getting one of the outcomes in the Frozen Peaks small wooden shack event")
    print("-Fixed fighting the same special enemy over and over when dying to it and restarting")
    print("-Fixed not being able to sneak past the bear and swapped sneak past and attack around")
    print("-Fixed storm power 1 saying -1 Damage instead of -1 Weapon Damage")
    print("-Fixed choosing sword to break the stone option saying -1 Damage too")
    print("\n---Item Balance Changes---")
    print("Shiny Sword: (16 dmg) -> (22 dmg)")
    print("Iron Sword (Blacksmith): (75 gold) -> (125 gold)")
    print("Steel Sword (Blacksmith): (200 gold) -> (300 gold)")
    print("Forest Enchant Book: (750 gold) -> (600 gold)")
    print("\nFrost Sword: (1150 gold) -> (1100 gold)")
    print("Frost Sword (Blacksmith): (1100 gold) -> (1000 gold)")
    print("Eagle Spear: (1000 gold) -> (900 gold)")
    print("Titanium Armour: (2000 gold) -> (1900 gold)")
    print("Frozen Peaks Health Crystal: (600 gold) -> (500 gold)")
    print("Frozen Peaks Enchant Book: (1600 gold) -> (1400 gold)")
    print("\nComposite Bow: (3100 gold) -> (2500 gold)")
    print("Rock Spear: (3500 gold) -> (3000 gold)")
    print("Shadow Blade: (4100 gold) -> (3700 gold)")
    print("Baron's Spear: (4200 gold) -> (3500 gold)")
    print("Ash Armour: (4200 gold) -> (3300 gold)")
    print("Dragonite Armour: (5200 gold) -> (4500 gold)")
    print("Klare Health Potion: (1000 gold) -> (800 gold)")
    print("Klare Max Health Potion: (1700 gold) -> (1300 gold)")
    print("Klare Enchant Book: (3700 gold) -> (3000 gold)")
    print("\n-------------------------------------------------------------------------")
